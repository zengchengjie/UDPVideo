package com.example.a10062376.udpvideo;
...
import com.example.a10062376.udpvideo.utils.AppDebug;
import com.example.a10062376.udpvideo.utils.MonitorInfo;
import com.example.a10062376.udpvideo.utils.Utility;
...
//		AppDebug.Log(PlayDirActivity.class, "[lifecycle]onCreate...");
        ...
        setContentView(com.example.a10062376.udpvideo.R.layout.activity_playdir);

        imageView = (ImageView) findViewById(com.example.a10062376.udpvideo.R.id.imageView);
        surfaceView = (SurfaceView) findViewById(com.example.a10062376.udpvideo.R.id.surfaceView);
        ...
        layoutAction = (View) findViewById(com.example.a10062376.udpvideo.R.id.layoutAction);
        layoutAction.setVisibility(View.GONE);
        buttonPrev = (Button) findViewById(com.example.a10062376.udpvideo.R.id.buttonPrev);
        buttonPrev.setOnClickListener(this);
        buttonPlay = (Button) findViewById(com.example.a10062376.udpvideo.R.id.buttonPlay);
        buttonPlay.setOnClickListener(this);
        buttonNext = (Button) findViewById(com.example.a10062376.udpvideo.R.id.buttonNext);
        buttonNext.setOnClickListener(this);
        textViewTime = (TextView) findViewById(com.example.a10062376.udpvideo.R.id.textViewTime);
        seekBar = (SeekBar) findViewById(com.example.a10062376.udpvideo.R.id.seekBar);
...
//			AppDebug.Log(PlayDirActivity.class, "PlayData...position:"+position);
            ...
            if (obj != null) {
                buttonPlay.setText(getString(com.example.a10062376.udpvideo.R.string.pause));
...
//					imageView.setVisibility(View.GONE);
//					surfaceView.setVisibility(View.GONE);
                    Utility.ShowToast(this, getString(com.example.a10062376.udpvideo.R.string.notsupport) + " [" + filename + "]");
...
//				e.printStackTrace();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.example.a10062376.udpvideo.R.id.buttonPrev:
                position--;
...
//			buttonNext.setEnabled(position < itemList.size()-1);
            ...
            PlayData();
            break;
            case com.example.a10062376.udpvideo.R.id.buttonPlay:
                pause = !pause;
                if (pause) {
                    if (player != null)
                        player.pause();
                        ...
                        handler.removeMessages(playnext);
                    buttonPlay.setText(getString(com.example.a10062376.udpvideo.R.string.play));
                } else {
                    if (player != null)
                        player.start();
                    else
                ...
                break;
            case com.example.a10062376.udpvideo.R.id.buttonNext:
                position++;
